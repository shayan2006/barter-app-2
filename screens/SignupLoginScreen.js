...
export default class SignupLoginScreen extends React.Component {
    ...
    userLogin = async()=>{
        await firebase.auth().signInWithEmailAndPassword(this.state.emailId,this.state.password).then(()=>{
     ...
     userSignUp = async(username,password,confirmPassword)=>{
         ...
         await firebase.auth().createUserWithEmailAndPassword(this.state.emailId,this.state.password).then((responce)=>{
             alert("user added")
